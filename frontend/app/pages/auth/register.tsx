...
export function Register() {
    ...
    function validateData(){
        ...
        if (!email.trim()) {
            throw new Error('Please enter a valid post email.');
        }
    }
        ...
        <div className="w-screen h-screen grid items-center">
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <p className="text-white-300 text-center uppercase text-sm font-bold -mb-2">Create your account</p>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="#" method="POST" className="space-y-3" onSubmit={register}>
                        {error && (
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm/6 font-medium text-white-300">
                                E-mail
                            </label>
                            <div className="mt-2">
                                <input
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                        Already a member?{' '}
                        <a href="/login" className="font-semibold text-[#e74c3c] hover:text-[#f8988a] transition-all">
                            Login here
                        </a>
                    </p>
                </div>
